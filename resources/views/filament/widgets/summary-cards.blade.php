@php
    ...
    $cards = [
        ...
        'monthly_revenue' => ['label' => 'Regalías del periodo', 'icon' => 'heroicon-o-banknotes', 'url' => '#revenue', 'color' => 'text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 dark:text-emerald-300'],
