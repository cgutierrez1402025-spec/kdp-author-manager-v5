...
- [`AUDITORIA_CONEXION_CATALOGO_KDP.md`](AUDITORIA_CONEXION_CATALOGO_KDP.md): trazabilidad con obras y publicaciones, cobertura real de campos y mejoras propuestas.
- [`MATRIZ_ACCIONES_POR_INFORME_KDP.md`](MATRIZ_ACCIONES_POR_INFORME_KDP.md): tablas, operaciones e integridad necesarias para cada descarga oficial de Amazon KDP.
